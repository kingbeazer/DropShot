...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DropShot.Models.League", b =>
                {
                    ...
                    b.Property<int>("TeamsPerDivisionMin")
                        .HasColumnType("int");

                    b.Property<int>("TeamsPerDivisionTarget")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DropShot.Models.LeagueDivision", b =>
                {
                    b.Property<int>("LeagueDivisionId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("LeagueDivisionId"));
                    ...
                    b.ToTable("LeagueDivisions");
                });

            modelBuilder.Entity("DropShot.Models.LeagueMembership", b =>
                {
                    b.Property<int>("LeagueId")
                        .HasColumnType("int");
                    ...
                    b.Property<byte?>("CurrentDivisionRank")
                        .HasColumnType("tinyint");
            ...
            modelBuilder.Entity("DropShot.Models.LeagueSeason", b =>
                {
                    b.Property<int>("LeagueSeasonId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DropShot.Models.LeagueDivision", b =>
                {
                    b.HasOne("DropShot.Models.Competition", "Competition")
                        .WithOne("LeagueDivision")
                        .HasForeignKey("DropShot.Models.LeagueDivision", "CompetitionId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("DropShot.Models.LeagueSeason", "Season")
                        .WithMany("Divisions")
            ...
            modelBuilder.Entity("DropShot.Models.LeagueMembership", b =>
                {
                    b.HasOne("DropShot.Models.League", "League")
